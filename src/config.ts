...
export const SELF_MODIFY_LIMIT_SESSION = 50;
export const SELF_MODIFY_LIMIT_DAY = 200;
...
// Run a third-party LLM security audit every N heartbeats.
export const SECURITY_AUDIT_INTERVAL_HEARTBEATS = 10;
